...
function StepOne({ onNext, onBack }) {
  ...
  return (
    <div className="step-one">
      ...
      <h2><i className="fas fa-lightbulb icon"></i>Identify Your Top Talents</h2>
      ...
      {error && <p className="error-message"><i className="fas fa-exclamation-triangle icon"></i>{error}</p>}
